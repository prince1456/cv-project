      ...
      <div className={classes.Wrapper}>
        ...
        <div className={classes.TextBox}>
          <div className={classes.TextBoxInner}>
            <EditableInput
              placeholder={data.trait1 || 'Disciplined'} changed={(value) => changeHandler(value, 'trait1')}
              inputType="InlinePrimaryTitle" />
            <EditableInput
              placeholder={data.trait2 || 'Structured'} changed={(value) => changeHandler(value, 'trait2')}
              inputType="InlinePrimaryTitle" />
            <EditableInput
              placeholder={data.trait3 || 'Always smiling'} changed={(value) => changeHandler(value, 'trait3')}
              inputType="InlinePrimaryTitle" />
            <EditableInput
              placeholder={data.trait4 || 'Good overview'} changed={(value) => changeHandler(value, 'trait4')}
              inputType="InlinePrimaryTitle" />
          </div>
        </div>
      </div>
          ...
          <div className={classes.BottomBoxInner9}>
            <div className={classes.BottomBoxTitleWrapper9}>
              <div className={classes.BottomBoxTitle9}>
                <p className={classes.WhyMeTitle9}>
                  Why me
                </p>
              </div>
